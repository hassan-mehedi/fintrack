ALTER TYPE "public"."audit_action" ADD VALUE 'password_reset_requested';--> statement-breakpoint
ALTER TYPE "public"."audit_action" ADD VALUE 'password_reset_completed';--> statement-breakpoint
